...
public class MaintenanceManager {
    ...
    public static void stopServer(){
        ...
        Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(plugin, new Runnable() {
            ...
            public void run() {
                int i = 10;
                while (i>0){
                    Bukkit.getServer().broadcastMessage(prefix + " §cZa " + i + " sekund serwer zostanie zatrzymany.");
                    Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "save-all");
                    try {
                        Thread.sleep(1000L);
    ...
    public static void restartServer(){
        Bukkit.getServer().broadcastMessage(prefix + " §cZa 1 minutę serwer zostanie uruchomiony ponownie.");
        Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "save-all");
        Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "whitelist on");
        Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(plugin, new Runnable() {
            @Override
            public void run() {
                Bukkit.getServer().broadcastMessage(prefix + " §cZa 30 sekund serwer zostanie uruchomiony ponownie.");
                Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "save-all");
            }
        }, 600L);
        Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(plugin, new Runnable() {
            @Override
            public void run() {
                Bukkit.getServer().broadcastMessage(prefix + " §cZa 15 sekund serwer zostanie uruchomiony ponownie.");
                Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "save-all");
            }
        }, 900L);
        Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(plugin, new Runnable() {
            ...
            public void run() {
                int i = 10;
                while (i>0){
                    Bukkit.getServer().broadcastMessage(prefix + " §cZa " + i + " sekund serwer zostanie uruchomiony ponownie.");
                    Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "save-all");
                    try {
                        Thread.sleep(1000L);
                    } catch (InterruptedException e) {
                ...
                Bukkit.getServer().broadcastMessage(prefix + " §cTrwa ponowne uruchamiani serwera...");
                Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "save-all");
                try {
                    Thread.sleep(1000L);
                } catch (InterruptedException e) {
    ...
    public static void reloadServer(){
        Bukkit.getServer().broadcastMessage(prefix + " §cZa 1 minutę pliki serwera zostaną przeładowane.");
        Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "save-all");
        Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "whitelist on");
        Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(plugin, new Runnable() {
            @Override
            public void run() {
                Bukkit.getServer().broadcastMessage(prefix + " §cZa 30 sekund pliki serwera zostaną przeładowane.");
                Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "save-all");
            }
        }, 600L);
        Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(plugin, new Runnable() {
            @Override
            public void run() {
                Bukkit.getServer().broadcastMessage(prefix + " §cZa 15 sekund pliki serwera zostaną przeładowane.");
                Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "save-all");
            }
        }, 900L);
        Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(plugin, new Runnable() {
            ...
            public void run() {
                int i = 10;
                while (i>0){
                    Bukkit.getServer().broadcastMessage(prefix + " §cZa " + i + " sekund pliki serwera zostaną przeładowane.");
                    Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "save-all");
                    try {
                        Thread.sleep(1000L);
                    } catch (InterruptedException e) {
    ...
    public static void maintenanceStart(){
        ...
        Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(plugin, new Runnable() {
            @Override
            public void run() {
                Bukkit.getServer().broadcastMessage(prefix + " §cZa 15 sekund pliki sodbędzie się przerwa techniczna.");
                Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "save-all");
            }
        }, 900L);
        Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(plugin, new Runnable() {
            ...
            public void run() {
                int i = 10;
                while (i>0){
                    Bukkit.getServer().broadcastMessage(prefix + " §cZa " + i + " sekund odbędzie się przerwa techniczna.");
                    Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "save-all");
                    try {
                        Thread.sleep(1000L);
                    } catch (InterruptedException e) {
