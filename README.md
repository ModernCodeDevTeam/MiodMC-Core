###### This plugin is still WIP! **Do not** try to use it at the moment. It is **not** finished and probably won't be finished as the plugin is mainly focused on DragonCraft server. Using this plugin at the moment may cause issues and server instability.
# DragonCraftCore
